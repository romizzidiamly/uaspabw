                  ...
                  <div class="col-lg-12 main-chart">
						...
						<table class="table table-responsive table-hover table-bordered table-striped">
							<form action="fungsi/edit/edit.php?kategori=edit" method="POST">
								<tr>
									<td>ID Kategori</td>
									<td><input type="text" readonly="readonly" class="form-control" value="<?php echo $hasil['id_kategori'];?>" name="id"></td>
								</tr>
								<tr>
									<td>Nama Kategori</td>
								...
								<tr>
									<td></td>
									<td><button class="btn btn-primary pull-right"><i class="fa fa-edit"></i> Update</button></td>
								</tr>
							</form>
						</table>
